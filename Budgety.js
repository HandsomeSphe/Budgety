    ...
    return{
        ...
        deleteItem: function(type, id){
         ...
         calculateBudget: function(){
              ...
              // calcaulate the percentage of the income spent
...
var UIController = (function(){
    ...
    var DOMstrings = {
        ...
        expensesContanier:".expenses__list",
    ...
    return {
        ...
        addListItem: function(obj, type){
            ...
            if(type === "inc"){
                ...
                element = DOMstrings.expensesContanier;
                 html = '<div class="item clearfix" id="expense-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>';

            };
            // Replace thye placeholder text with real data
...
var controller = (function(BudgetCtrl, UICtrl){
    ...
    var setupEventListener = function(){
        ...
        document.querySelector(DOM.contanier).addEventListener("click", ctrlDeleteItem);
    ...
    var CtrlAddItem =  function(){
        ...
        //1. get input from the data field
    ...
    var ctrlDeleteItem = function(){
        ...
        if( itemID){
            ...
            //2. remove items form the UI
            UICtrl.deleteListItem(itemID);
            //3. update and show a new budget
            updateBudget();
